...
public interface ISpelling extends Serializable {
	...
	/**
	 * Returns an iterator of lines off a given text enumerated between
	 * boundaries
	 * 
	 * @param id
	 *            Id
	 ...
	 * @param lastLine
	 *            Last included line
	 * @return An iterator of lines off a given text enumerated between
	 *         boundaries
	 */
	 ...
	 * @param word
	 *            Word to search
	 * @return True if than iterator of lines off a given text enumerated
	 *         between boundariese word exists in the dictionary, false if not
	 */
