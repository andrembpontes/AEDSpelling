...
public class TestLists {
	...
	public void testListElements(java.util.List<String> javaList, List<String> arrayList, List<String> linkedList) {
		// test size
		Assert.assertEquals("LinkedList size error", javaList.size(), this.linkedList.size());
		Assert.assertEquals("ArrayList size error", javaList.size(), this.arrayList.size());
		...
		while (linkedListIterator.hasNext() || arrayListIterator.hasNext() || javaIterator.hasNext()) {
			Assert.assertEquals("LinkedListIterator hasNext error!", linkedListIterator.hasNext(), javaIterator.hasNext());
			Assert.assertEquals("ArrayListIterator hasNext error!", arrayListIterator.hasNext(), javaIterator.hasNext());
			
			String str = javaIterator.next();
			Assert.assertEquals("ArrayList integrity error!", arrayListIterator.next(), str);
			Assert.assertEquals("LinkedList itegrity error!", linkedListIterator.next(), str);
		}
	}
}
